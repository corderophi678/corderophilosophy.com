...
const theme = {
  ...
  post: {
    colors: {
      ...
      authorBorder: colors.firstDark,
      authorLogoBg: colors.firstSuperLight,
      authorLogoText: colors.firstDark,
      bold: colors.middle,
      blockquoteFrame: colors.first,
  ...
  topBar: {
    colors: {
      ...
      logoHover: colors.firstDark,
      logoPostHover: colors.firstDark
    },
    backgrounds: {
